...
const tools = [jsonFormatter, uuidGenerator, passwordGenerator, wordCounter, caseConverter, slugify, loremIpsum, base64Codec, urlCodec, hashGenerator, timestampConverter, colorConverter, jwtDecoder, htmlCodec, numberBaseConverter, textDiff, csvJsonConverter, regexTester, markdownPreview, imageToBase64, findReplace, lineSort, duplicateLineRemover, randomNumber, percentageCalculator, jsonValidator, jsonMinifier, jsonCompare, jsonToYaml, yamlToJson, removeEmptyLines, trimLines, addPrefixSuffix, whitespaceCleaner, sqlFormatter, yamlFormatter, yamlValidator, xmlFormatter, qrCodeGenerator, randomStringGenerator, fakeDataGenerator, colorPicker, gradientGenerator, imageCompressor, imageResizer, pngToJpg, jpgToWebp, pdfMerge, cropImage, rotateImage, flipImage, jpgToPng, webpToPng, webpToJpg, pngToWebp, svgOptimizer, imageMetadata, imageColorExtractor, imageConverter, pdfSplit, pdfCompress, pdfRotate, pdfDeletePages, pdfExtractPages, pdfReorderPages, imagesToPdf, pdfToImages, pdfMetadata, asciiConverter, binaryConverter, hexCodec, unicodeEscape, rot13, morseCodec, contrastChecker, colorBlindnessSimulator, barcodeGenerator, unitConverter, cronGenerator, dateCalculator, jwtEncoder, cssMinifier, colorPaletteGenerator, markdownToHtml, aspectRatioCalculator, nanoidGenerator, readingTimeEstimator, boxShadowGenerator, urlParser, queryStringJson, tipCalculator, bmiCalculator, imageWatermark, markdownToPdf, cssAnimationGenerator, faviconGenerator, timezoneMeetingPlanner, curlToFetch, csvViewer, keyboardTester, glassmorphismGenerator, deviceTester, backgroundRemover, imageTiler, imageSplitter] as const;
