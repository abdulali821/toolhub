...
<a
	...
	class="tool-card group relative block overflow-hidden rounded-lg border border-border bg-bg-elevated p-5 no-underline shadow-sm transition-[border-color,transform,box-shadow] duration-[var(--duration-base)] ease-[var(--ease-out)] hover:-translate-y-0.5 hover:border-accent/35 hover:shadow-md"
>
	<span
	...
	<div class="flex items-start gap-3">
		...
		<div class="min-w-0 flex-1">
			<span
				class="font-display text-lg font-semibold tracking-tight text-fg transition-colors duration-[var(--duration-fast)] group-hover:text-accent"
			>
				{name}
			</span>
